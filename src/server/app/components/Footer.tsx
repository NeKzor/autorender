...
const Footer = () => {
  return (
    <footer className={tw`bg-white shadow dark:bg-gray-900`}>
      <div className={tw`w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between`}>
        <span className={tw`text-sm text-gray-500 sm:text-center dark:text-gray-400`}>
          © 2023{' '}
