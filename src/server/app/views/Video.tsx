...
import { FixedDemoStatus, MapModel, PendingStatus, RenderQuality, UserPermissions, Video } from '~/shared/models.ts';
        ...
        <div className={tw`xl:w-[1280px]`}>
          {!hasVideo &&
            ...
            <>
              ...
              {!!((state?.user?.permissions ?? 0) & UserPermissions.RerenderVideos) &&
                (
                  <div className={tw`mt-4`}>
                    <button
                      id='video-retry-render-button'
                      type='button'
                    ...
                    >
                      ...
                      <svg
                        aria-hidden='true'
                        role='status'
                        className={tw`hidden w-4 h-4 text-white animate-spin`}
                        viewBox='0 0 100 101'
                        fill='none'
                        xmlns='http://www.w3.org/2000/svg'
                      >
